...
/**
 * 클래스 명 : AlbumDividerDecoration class
 * 설명 : 갤러리 아이템(이미지, 동영상)을 보여줄때 구분선 정의
 */
public class AlbumDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public AlbumDividerDecoration(Resources resources, int layout) {

        divider = resources.getDrawable(layout);
        mInsets = 1;
    }
